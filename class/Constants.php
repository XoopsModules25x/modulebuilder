...
interface Constants
{
    ...
    public const FIELD_ELE_RADIO_ONOFFLINE = 31;
    // FIRST_FIELDELEMENT_TABLE must be +1 higher than the highest FIELD_ELE... constant
    public const FIRST_FIELDELEMENT_TABLE = 32;
