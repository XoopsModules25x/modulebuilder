...
VALUES
  (1, 'My Module', 'mymoduledirname', '1.0.0', '1.0.0', '7.0', '2.5.10', '1.2', '5.6', 'This module is for doing following...', 'TDM XOOPS', 'info@email.com', 'https://xoops.org', 'XOOPS Project', 'XOOPS Development Team', 'GPL 2.0 or later', 'release_info', 'release_info file', 'link to manual file',
...
CREATE TABLE `modulebuilder_tables` (
  ...
  `table_reads`         TINYINT(1) UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE `modulebuilder_fields` (
  ...
  `field_ihead`     TINYINT(1)   UNSIGNED NOT NULL DEFAULT '0',
  `field_ibody`     TINYINT(1)   UNSIGNED NOT NULL DEFAULT '0',
  `field_ifoot`     TINYINT(1)   UNSIGNED NOT NULL DEFAULT '0',
