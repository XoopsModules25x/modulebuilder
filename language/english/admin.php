...
define('_AM_MODULEBUILDER_ADMIN_BUILD_TEST', 'Save and restore test data of selected module');
...
define('_AM_MODULEBUILDER_ADMIN_BUILD_CHECK', 'Run data check for errors/inconsistencies before building the module');
define('_AM_MODULEBUILDER_CHECKPREBUILD', 'Result of checking data before building the module');
define('_AM_MODULEBUILDER_CHECKPREBUILD_NOERRORS', 'Congratulations! No errors or warnings found');
define('_AM_MODULEBUILDER_CHECKPREBUILD_ERROR', 'Error: ');
define('_AM_MODULEBUILDER_CHECKPREBUILD_ERROR_DESC', 'Errors must be solved');
define('_AM_MODULEBUILDER_CHECKPREBUILD_WARNING', 'Warning: ');
define('_AM_MODULEBUILDER_CHECKPREBUILD_WARNING_DESC', 'Warnings should be solved in order to get proper functions');
define('_AM_MODULEBUILDER_CHECKPREBUILD_FOUND', 'Following errors/warning have been found:');
define('_AM_MODULEBUILDER_CHECKPREBUILD_SOLVE', 'Please solve these problems and try again');
define('_AM_MODULEBUILDER_CHECKPREBUILD_BROKEN1', "The table '%t' should use broken functionality, but the table do not have a 'Select Status' field, which is obligatory for this function");
define('_AM_MODULEBUILDER_CHECKPREBUILD_FIELDS1', "The field '%f' in table '%t' have no params selected, but each field must have minimum one parameter");
define('_AM_MODULEBUILDER_CHECKPREBUILD_FIELDS2', "The field '%f' in table '%t' should be used on user side: Param '" . _AM_MODULEBUILDER_FIELD_USER . "' is selected, but no selection is made, where it should be shown ('User index:...' or 'User file:...')");
define('_AM_MODULEBUILDER_CHECKPREBUILD_FIELDS3', "The field '%f' in table '%t' should be used on user side, but you made multiple decision where ('header' and/or 'body' and/or 'footer'). It is recommended to select only one section per index or item file");
define('_AM_MODULEBUILDER_CHECKPREBUILD_BLOCK1', "The table '%t' should use block, but no selection is made which fields should be shown in the block");
define('_AM_MODULEBUILDER_CHECKPREBUILD_BLOCK2', "The table '%t' should use block, but blocks use e.g. function 'new' or 'latest'. For these functions a date field is necessary, but the table doesn't contain any date field");
define('_AM_MODULEBUILDER_CHECKPREBUILD_COMMENTS1', "The use of comments is activated for tables '%t'. For proper function it is currently only possible to use comments for one table");
define('_AM_MODULEBUILDER_CHECKPREBUILD_COMMENTS2', "The table '%t' should use comment functionality, but the table do not have a '%f' field, which is obligatory for this function");
