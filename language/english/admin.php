...
define('_AM_MODULEBUILDER_CHECKPREBUILD_BROKEN1', "The table '%t' should use broken functionallity, but the table do not have a 'Select Status' field, which is obligatory for this function");
